...
namespace System.Collections.Generic
{
    public static class EnumerableExtensions
    {
        ...
        {
            return collection.Where(x => x.Type.Equals("C") && x.MovementStatus.Equals(MovementStatus.Launched)).Sum(x => x.TotalValue);
        }
        ...
        {
            return collection.Where(x => x.Type.Equals("D") && x.MovementStatus.Equals(MovementStatus.Launched)).Sum(x => x.TotalValue);
        }
    }
}